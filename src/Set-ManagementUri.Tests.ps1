...
Describe "Set-ManagementUri" -Tags "Set-ManagementUri" {
	...
	Context "Set-ManagementUri" {
		...
		It "Set-ManagementUri-WithNotExistingManagementCredentialIdShouldThrowContractException" -Test {
			...
			# Act/Assert
			{ Set-ManagementUri -svc $svc -Type $type -Name $name -Value $value -ManagementCredentialId $notExistingManagementCredentialId } | Should ThrowErrorId 'Contract';
		}
	}
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUJPr6uR07QOYJPl3W/n3SBHDd
# 99ugghHCMIIEFDCCAvygAwIBAgILBAAAAAABL07hUtcwDQYJKoZIhvcNAQEFBQAw
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBRORG+Q0hi7ONHB
# A4qJNJc1dvSyvjANBgkqhkiG9w0BAQEFAASCAQDH2G3sDmoDIIaH8nMhvlLLIaA0
# ng//4JsxySaMqt09gKJ1Livq5uYfAGZexLjGobeGoHsarIyAX3KxVs73fCgG9mSP
# dBr7FG+5GP7hQ5R7NVR2rYvUZdXdRtVpvBmSIu71/+w4XG5G8fOdNkFxmZ9ZNHqX
# JJUtvz+V7897Z6zFyG9wRYv6uZshlCMaItN1E7JLldi8w5I6xQcNnGUnCxyBYBQN
# OOTMOf867FNTVIPMnvZeMBekXOohSQ4cFkZ6jr8Izz3QxO3tFiHIMBZsITxsxVZr
# 8oOEgFyA7Pyz1eURziZstu0IyHfaX5vpkmWhKNiXCi1Fb/swhiUj31yKke24oYIC
